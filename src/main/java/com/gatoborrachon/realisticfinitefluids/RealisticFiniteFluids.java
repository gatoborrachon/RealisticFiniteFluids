...
public class RealisticFiniteFluids
{
	...
	public void serverStarting(FMLServerStartingEvent event) {
	    ...
	    event.registerServerCommand(new CommandFluidKillswitch()); // ya que estás aquí, este es el mismo lugar donde registras el comando killswitch
	}
