...
public class ModBlocks {
    ...
    public static void init() {
        FINITE_WATER_FLOWING = new BlockNewWater("finite_water_flowing", FluidRegistry.WATER, Material.WATER);
        ...
        FINITE_LAVA_FLOWING  = new BlockNewLava("finite_lava_flowing", FluidRegistry.LAVA, Material.LAVA);
