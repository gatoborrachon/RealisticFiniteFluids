            ...
            while ((line = br.readLine()) != null) {
                ...
                if (s.startsWith("S:infiniteModdedFluids")) {
                    ...
                    if (s.contains("<")) {
                        ...
                        // Si hay algo despu�s del '<' en la misma l�nea, ignoramos (no es com�n)
                        // Leemos siguientes l�neas hasta encontrar '>' de cierre
                        while ((line = br.readLine()) != null) {
