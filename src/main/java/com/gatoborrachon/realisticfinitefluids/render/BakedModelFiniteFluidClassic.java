...
public class BakedModelFiniteFluidClassic implements IBakedModel {
	...
	public BakedModelFiniteFluidClassic(/*Optional<TRSRTransformation> transformation, */
			VertexFormat vertexFormat, IModelState state, TextureAtlasSprite spriteFlowing, TextureAtlasSprite spriteStill, Fluid fluid) {
	...
	public List<BakedQuad> getQuads(@Nullable IBlockState state, @Nullable EnumFacing side, long rand) {
		...
		if (colorFluid != null) color = colorFluid;
		...
		// INVENTORY RENDER
		if (state == null) {
			return renderer.renderItemFluid(vertexFormat, color, spriteStill);
			/*return renderer.renderItemFluid(
				color,
				spriteStill,
				vertexFormat,
				transformation
